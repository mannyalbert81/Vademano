...
<style type="text/css">
 h4 {
    ...
    <body class="cuerpo">
    <form  action="<?php echo $helper->url("DelaMano","index3"); ?>" method="post" class="col-lg-12">
					         ...
					         <tr class="info">
					            ...
					            <?php if(!empty($resultInd)) {foreach($resultInd as $res) {?>
					        		...
					        		<tr>
						               ...
						               <td style="font-size: 12px;"> <?php echo $res->descripcion_industria; ?> </td> 
						               <td style="font-size: 11px;"><a href="view/DevuelveCatalogoView.php?id_valor=<?php echo $res->id_industria; ?>&id_nombre=id_industria&tabla=industria&campo=pdf" target="_blank"><img src="view/images/logo_pdf.png" class="img-responsive zoom" width="50" height="50"></a></td> 
