          ...
          <?php if ($resultEdit !="" ) { foreach($resultEdit as $resEdit) {?>
		         ...
		         <div class="row">
				  <div class="col-xs-3 col-md-3">
				  	...
				  	<input type="email"  name="correo_usuario" id="correo_usuario" value="<?php if ($sel_correo_usuario !="") {echo $sel_correo_usuario; } else {echo $resEdit->correo_usuario;}     ?>" class="form-control"  />
					<input type="hidden" name="id_usuario" id="id_usuario" value="<?php if ($sel_id_usuario !="") {echo $sel_id_usuario; } else {echo $resEdit->id_usuario;}     ?>" class="form-control"/>
					
					<div id="mensaje_nombre" class="errores"></div>
				  </div>
				  <div class="col-xs-3 col-md-3">
				  	<p  class="formulario-subtitulo" >Confirme Correo </p>
				  	<input type="email"  name="ccorreo_usuario" id="ccorreo_usuario" value="<?php if ($sel_correo_usuario !="") {echo $sel_correo_usuario; } else {echo $resEdit->correo_usuario;}     ?>" class="form-control"  />
						
				  </div>
				
				  <div class="col-xs-3 col-md-3">
				  	<p  class="formulario-subtitulo" >Nombres</p>
				  	<input type="text"  name="nombres_usuario" value="<?php if ($sel_nombres_usuario !="") {echo $sel_nombres_usuario; } else {echo $resEdit->nombres_usuario;}     ?>" class="form-control"/> 
				  </div>
				  <div class="col-xs-3 col-md-3">
				  	<p   class="formulario-subtitulo" >Apellidos </p>
				  	<input type="text" name="apellidos_usuario" value="<?php if ($sel_apellidos_usuario !="") {echo $sel_apellidos_usuario; } else {echo $resEdit->apellidos_usuario;}     ?>" class="form-control"/>
				  </div>
				</div>
	           ...
	           <div class="row">
				  ...
				  <div class="col-xs-2 col-md-2">
				  	...
				  	<input type="text" name="telefono_usuario" value="<?php if ($sel_telefono_usuario !="") {echo $sel_telefono_usuario; } else {echo $resEdit->telefono_usuario;}     ?>" class="form-control"/>
				  </div>
				  <div class="col-xs-2 col-md-2">
				  	<p  class="formulario-subtitulo" >Celular  Usuario</p>
				  	<input type="text" name="celular_usuario" value="<?php if ($sel_celular_usuario !="") {echo $sel_celular_usuario; } else {echo $resEdit->celular_usuario;}     ?>" class="form-control"/> 
				  </div>
				  <div class="col-xs-3 col-md-3">
