	            	...
	            	<tr>
					 ...
					 <td style="font-size: 12px;"><div class="contenedor-img ejemplo-1"><img type="image" name="image" src="view/DevuelveImagen.php?id_valor=<?php echo $res->id_fichas; ?>&id_nombre=id_fichas&tabla=fichas_fotos&campo=foto_fichas_fotos"  alt="<?php echo $res->id_fichas_fotos; ?>" width="90" height="75" >      
			           ...
			           <h6><?php echo $res->nombre_fichas; ?> </h6>  
		                ...
		                <td>
			           		<div class="right">
			                    <a href="<?php echo $helper->url("FichasProductos","verFichaOnline"); ?>&id_fichas=<?php echo $res->id_fichas; ?>" class="btn btn-info" target="_blank"><i class="glyphicon glyphicon-eye-open"></i></a>
			                </div>
		               ...
		               <td>
			             ...
			             <td>   
			                	<div class="right">
			                    <a href="<?php echo $helper->url("FichasProductos","borrarId"); ?>&id_fichas=<?php echo $res->id_fichas; ?>" class="btn btn-danger" onClick="return mensaje();"><i class="glyphicon glyphicon-trash"></i></a>
			                </div>
			                <hr/>
		               </td>
