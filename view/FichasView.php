...
<html lang="es">
      <head>
        <meta charset="utf-8"/>
        <title>Fichas - Vademano 2015</title>
		...
		$(document).ready(function(){
		    ...
		    $("#btn_guardar_ficha").click(function() 
			{
		    	...
		    	if (encabezado_tabla_fichas == "")
		    	{
			    	...
			    	$("#mensaje_encabezado_tabla_fichas").text("Campo Vacio");
		    		$("#mensaje_encabezado_tabla_fichas").fadeIn("slow"); //Muestra mensaje de error
		            return false;
			    }
		    	else 
		    	{
					
			    	$("#mensaje_encabezado_tabla_fichas").fadeOut("slow"); //Muestra mensaje de error
			...
			$( "#encabezado_tabla_fichas" ).focus(function() {
				$("#mensaje_encabezado_tabla_fichas").fadeOut("slow");
    		});
    ...
    <body class="cuerpo">
       ...
       <?php include("view/modulos/headadmin.php"); ?>
		...
		?>
  		 ...
  		 <form action="<?php echo $helper->url("Fichas","index"); ?>" method="post" enctype="multipart/form-data"  class="col-lg-6">
        	    <h4>Insertar Ficha </h4>
            	<hr/>
	       ...
	       <div class="row">
			  <div class="col-xs-6 col-md-6">
			  	<p  class="formulario-subtitulo" >Nombre Producto </p>
			  		...
			  		<input type="text" name="nombre_fichas" id="nombre_fichas" value="<?php echo $sel_nombre_fichas; ?>" class="form-control"/>
	     		  	<input type="hidden" name="id_fichas" id="id_fichas" value="<?php echo $id_fichas; ?>" class="form-control"/>
			
		    		<div id="mensaje_nombre_fichas" class="errores"></div>
			 
			  </div>
			  <div class="col-xs-6 col-md-6">
			  	<p  class="formulario-subtitulo" >Foto Producto</p>
		  ...
		  <div class="row">
			  ...
			  <div class="col-xs-12 col-md-12">
			  	...
			  	<input type="text" name="farmacocinetica_fichas" id="farmacocinetica_fichas" value="<?php echo $sel_farmacocinetica_fichas; ?>" class="form-control"/>
				<div id="mensaje_farmacocinetica_fichas" class="errores"></div>
			  </div>
           ...
           <div class="row">
			  <div class="col-xs-12 col-md-12">
			  	...
			  	<input type="text" name="accion_terapeutica_fichas" id="accion_terapeutica_fichas" value="<?php echo $sel_accion_terapeutica_fichas; ?>" class="form-control"/>
		...
		<hr>
		   <div class="row">
			  <div class="col-xs-12 col-md-12" style="text-align: center;" >
			  	<input type="submit" id="btn_guardar_ficha" name="btn_guardar_ficha" value="Guardar" class="btn btn-success"/>
			  </div>
			</div>     
        ...
        <div class="col-lg-6">
            <h4>Fichas de Productos Creadas</h4>
            <hr/>
        </div>
	         ...
	         <tr>
	            ...
	            <?php foreach($resultSet as $res) {?>
	        		<tr>
		               ...
		               <td>
			           		<div class="right">
			                    <a href="<?php echo $helper->url("Fichas","index"); ?>&id_fichas=<?php echo $res->id_fichas; ?>" class="btn btn-warning">Editar</a>
			                </div>
			            
			             </td>
			             <td>   
			                	<div class="right">
			                    <a href="<?php echo $helper->url("Fichas","borrarId"); ?>&id_fichas=<?php echo $res->id_fichas; ?>" class="btn btn-danger">Borrar</a>
			                </div>
			                <hr/>
		               </td>
		    		</tr>
